...
11. Use the models to predict the test data, plot the ROC curves for the predictions for both models, and calculate the areas under the ROC curve. Does your answer to the previous exercise hold for the testing data as well? Explain your reasoning.
...
-   Submit reviews for the projects on the peer review form [here](https://example.com/) (just like you did during the session on Friday)
