...
subtitle: "Due: 30 September, 16:00 UK time"
output: 
  tufte::tufte_html:
    css: ../hw.css
...
This assignment assumes that you have followed the *first time setup instructions* and watched the following videos.
If you haven't yet done so, please go and complete the following before continuing.

-   [first time setup instructions](https://idsed.digital/troubleshoot/)

-   Watch the following videos listed [here](https://idsed.digital/week01/#videos "Link to Week 1 videos"):
...
-   **Repository:** A Git repository contains all of your project's files and stores each file's revision history.
    ...
    -   All repos associated with this course are housed in a GitHub organization: [`ids-s1-21`](https://github.com/ids-s1-21). The organization is set up such that students can only see repos they have access to, but the course staff can see all of them.
...
-   are a member of the course GitHub organization
    ...
    -   You can check this by going to [`ids-s1-20`](https://github.com/ids-s1-21) and confirming that you can see a repository called `hw-00-pet-names-YOUR_GITHUB_USERNAME` where `YOUR_GITHUB_USERNAME` is, well, your github username.
...
-   are a member of the course RStudio Cloud space
    ...
    -   You can check this by going to [rstudio.cloud](https://rstudio.cloud/ "RStudio Cloud") and confirming that you can see "IDS 2021" listed as one of your workspaces on the left menu.
...
If you believe you've completed all of the prerequisites and you are still having difficulty, review troubleshooting advice [here](https://idsed.digital/troubleshoot/).
...
The [Opening a Project](https://idsed.digital/troubleshoot/setup/openingaproject/) page walks you through the process of getting information of the repo to be cloned, cloning your repo in a new RStudio Cloud project, and getting started with the analysis.
...
In order to push your changes to GitHub, you will need to click on **Push**.
...
-   `openintro`: a package that contains the datasets from OpenIntro books - part of the reading for this course.
...
Firstly, this week, we will not be marking your HW or Lab as they are just a practice.

However, for the rest of the course, your teaching team will mark your work using your __knitted file__ (ending in .html or .md) and not your R Markdown (.Rmd) file that you use to create and run your code. This is because your knitted file is a completely _reproducible_ document where we can see your code and its output without having to run any code ourselves. It is important you knit your work while working on your assessments as we will only mark what is in the knitted file and not what is in the .Rmd file.
```

✏️ *Now is a good time to do one last knit, then commit and push your changes to GitHub with an appropriate commit message. Commit and push all changed files so that your Git pane is cleared up afterwards. Make sure that your last push to the repo comes before the deadline, 30 September, 16:00 UK time. You can confirm that what you committed and pushed are indeed in your repo that we will see by visiting your repo on GitHub. Its also a good idea to check all your work is in the knitted file.*

## Getting help

If you have any questions about the assignment, please post them on Piazza!

[^1]: Only pushing requires talking to GitHub, this is why you're asked for your username and password for the first time at that point.
