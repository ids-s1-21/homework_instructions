...
subtitle: "Due: 14 October, 16:00 UK time"
output: 
  tufte::tufte_html:
    css: ../hw.css
...
-   This assignment assumes that you've worked through all materials for [week 1](https://idsed.digital/week01/), [week 2](https://idsed.digital/week01/), and [week 3](https://idsed.digital/week01/).
...
In order to push your changes to GitHub, first follow the instructions on the [Push and Pull Changes](https://idsed.digital/troubleshoot/setup/openingaproject/#push-and-pull-changes) instructions on the [Opening a Project](https://idsed.digital/troubleshoot/setup/openingaproject/) page, then click on **Push**.
...
1.  Create another data visualisation based on these data and interpret it. You can choose any variables and any type of visualisation you like, but it must have at least three variables, e.g. a scatterplot of x vs. y isn't enough, but if points are coloured by z, that's fine.
